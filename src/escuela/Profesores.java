...
public class Profesores extends com.matisse.reflect.MtObject {
     ...
     * @see #removeImparten
     */
    public final escuela.Clases[] getImparten() {
        return (escuela.Clases[])getSuccessors(getImpartenRelationship(getMtDatabase()), escuela.Clases.class);
    }
    ...
    public final <E extends com.matisse.reflect.MtObject> com.matisse.MtObjectIterator<E> impartenIterator() {
        return this.<E>successorIterator(getImpartenRelationship(getMtDatabase()), escuela.Clases.class);
    }
     ...
     * @see #removeImparten
     */
    public final void setImparten(escuela.Clases[] succs) {
     ...
     * @see #removeImparten
     */
    public final void prependImparten(escuela.Clases succ) {
     ...
     * @see #impartenIterator
     */
    public final void appendImparten(escuela.Clases succ) {
     ...
     * @see #impartenIterator
     */
    public final void appendImparten(escuela.Clases[] succs) {
     ...
     * @see #impartenIterator
     */
    public void removeImparten(escuela.Clases[] succs) {
     ...
     * @see #impartenIterator
     */
    public void removeImparten(escuela.Clases succ) {
