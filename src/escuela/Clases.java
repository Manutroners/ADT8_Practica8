...
public class Clases extends com.matisse.reflect.MtObject {
     ...
     */
    public final escuela.Profesores[] getImpartida_por() {
        return (escuela.Profesores[])getSuccessors(getImpartida_porRelationship(getMtDatabase()), escuela.Profesores.class);
    }
    ...
    public final <E extends com.matisse.reflect.MtObject> com.matisse.MtObjectIterator<E> impartida_porIterator() {
        return this.<E>successorIterator(getImpartida_porRelationship(getMtDatabase()), escuela.Profesores.class);
    }
     ...
     * @see #removeImpartida_por
     */
    public final void setImpartida_por(escuela.Profesores[] succs) {
     ...
     * @see #removeImpartida_por
     */
    public final void prependImpartida_por(escuela.Profesores succ) {
     ...
     * @see #impartida_porIterator
     */
    public final void appendImpartida_por(escuela.Profesores succ) {
     ...
     * @see #impartida_porIterator
     */
    public final void appendImpartida_por(escuela.Profesores[] succs) {
     ...
     * @see #impartida_porIterator
     */
    public void removeImpartida_por(escuela.Profesores[] succs) {
     ...
     * @see #impartida_porIterator
     */
    public void removeImpartida_por(escuela.Profesores succ) {
